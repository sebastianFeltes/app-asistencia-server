...
export const insertIdRel = `INSERT INTO rel_curso_alumnos (id_relacion, id_alumno,id_curso) VALUES (?,?,?)`;
...
export const updateDocente = `UPDATE docentes SET nombre =?, tipo_dni =?, nro_dni=?, id_rol =?, apellido =?, activo =? WHERE id_docente = ?`;
